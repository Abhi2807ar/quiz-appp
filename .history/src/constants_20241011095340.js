export const jsQuizz = {
    questions: [
      ...
      },
      {
        ...
        type: "MCQs",
        correctAnswer: "Which of the following is not an operating system?",
        choices: [
          "Windows",
          "Linux",
          "Oracle",
      ...
      },
      {
        ...
        type: "MCQs",
        correctAnswer: "program in the execution",
      },
      {
        question: "If you want to connect to your own computer through the Internet from another location, you can use ?",
        choices: ["FTP ", "e-mail ", "instant message", "Telnet "],
        type: "MCQs",
        correctAnswer: "Telnet",
      },
      {
        question: "Unlike filters queries can be saved as in a database ?",
        choices: ["TCL", "DCL", "DML", "DDL"],
        type: "MCQs",
        correctAnswer: "TCL",
      },
      {
